	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'ghoul':
				...
				frames = tex;
				animation.addByPrefix('idle', 'Ghoul Idle Dance', 24, true);
			...
			case 'angryghoul':
				...
				frames = tex;
				animation.addByPrefix('idle', 'Ghoul Pissed ALT Idle Dance', 24, true);
			...
			case 'soulfire':
				...
				frames = tex;
				animation.addByPrefix('idle', 'SoulFireGhoul Idle', 24, true);
			...
			case 'susghoul':
				...
				animation.addByPrefix('idle', 'GHOULhatesmogus Idle Dance', 24, true);
			...
			case 'obama':
				...
				playAnim('idle');
			case 'padoru':
				frames = Paths.getSparrowAtlas('Padoru', 'shared', true);

				animation.addByPrefix('idle', 'Padoru Idle', 24, true);
				animation.addByPrefix('singUP', 'Padoru Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Padoru Right', 24, false);
				animation.addByPrefix('singDOWN', 'Padoru Down', 24, false);
				animation.addByPrefix('singLEFT', 'Padoru Left', 24, false);
